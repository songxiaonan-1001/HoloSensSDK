 ...
 * @Description: java类作用描述 自定义文本输入框
 * @CreateDate: 2020-01-04 09:29
 * @Version: 1.0
 */
...
public class CustomEditText extends EditText{
    ...
    private int numSize = 20;//字数统计的大小
...
//        canvas.drawText(numStr, editWidth-mBound.width()-10, editHeight-mBound.height()-25, mPaint);
    }
    @Override
