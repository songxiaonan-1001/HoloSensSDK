...
public class PopupWindowList {
    ...
    private PopWIndowAdpater mPopwindowAdapter;
...
//        mPopView.setAdapter(new PopWIndowAdpater(mContext,mResid, mItemData));
        ...
        if (mPopupWindowHeight == 0) {
            mPopupWindowHeight = mItemData.length * mPopView.getMeasuredHeight();
