...
public class StickyGridHeadersBaseAdapterWrapper extends BaseAdapter {
    ...
    private static final int ID_FILLER = -0x02;

    static final int ID_HEADER = -0x01;

    private static final int ID_HEADER_FILLER = -0x03;
    ...
    private static final int VIEW_TYPE_HEADER_FILLER = 0x02;
    ...
    Position translatePosition(int position) {
        int numHeaders = mDelegate.getNumHeaders();
        if (numHeaders == 0) {
    ...
    protected class FillerView extends View {
        ...
        void setMeasureTarget(View lastViewSeen) {
    ...
    protected class Position {
        ...
        Position(int position, int header) {
            mPosition = position;
            mHeader = header;
        }
    }
