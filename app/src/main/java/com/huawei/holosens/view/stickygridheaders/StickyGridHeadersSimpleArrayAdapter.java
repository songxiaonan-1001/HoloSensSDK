...
public class StickyGridHeadersSimpleArrayAdapter<T> extends BaseAdapter implements
    ...
    private StickyGridHeadersSimpleArrayAdapter(Context context, List<T> items, int headerResId,
                                                int itemResId) {
        init(context, items, headerResId, itemResId);
    }

    private StickyGridHeadersSimpleArrayAdapter(Context context, T[] items, int headerResId,
                                                int itemResId) {
