...
public class StickyGridHeadersGridView extends GridView implements OnScrollListener,
    ...
    private static final int TOUCH_MODE_FINISHED_LONG_PRESS = -2;
    ...
    private int mMotionHeaderPosition;
     ...
     *         found.
     */
    private View getHeaderAt(int position) {
    ...
    private boolean performHeaderClick(View view, long id) {
    ...
    private boolean performHeaderLongPress(View view, long id) {
    ...
    void detachHeader(View header) {
        ...
        try {
            @SuppressWarnings("JavaReflectionMemberAccess") Method method = View.class.getDeclaredMethod("dispatchDetachedFromWindow");
            method.setAccessible(true);
    ...
    interface OnHeaderLongClickListener {
    ...
    class RuntimePlatformSupportException extends RuntimeException {
        ...
        RuntimePlatformSupportException(Exception e) {
