...
//
//            if(!(CheckRoms.isFlyme()||CheckRoms.isOppo()||CheckRoms.isEmui())){
//
...
//            result = 4;
//        } else if (CheckRoms.isEmui() && (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N)) {
//
//            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
//                setStateBar(activity);
//            }
//
//        } else {
//            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
...
//
//        if (result != 0) {
//            StatesBarUtil.setStatusBarColor(activity, Color.WHITE);
//        }
//
//
//        return result;
//    }
    ...
    static void setStateBar(Activity activity) {
        try {
    ...
    public static void setLightStatusBarIcon(Activity context, boolean lightMode) {
