...
public class DeviceListEditAdapter extends BaseQuickAdapter<DeviceResponseBean.DevicesBean, BaseViewHolder> {
    ...
    public DeviceListEditAdapter(int layoutResId, @Nullable List<DeviceResponseBean.DevicesBean> data) {
    ...
    public interface DeviceSelectedListener{
        void onDeviceSelected(DeviceResponseBean.DevicesBean item);
    }
