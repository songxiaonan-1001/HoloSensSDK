...
public class TipDialog  extends Dialog {
    ...
    public TipDialog setPositive(String positive) {
    ...
    public TipDialog setNegtive(String negtive) {
    ...
    public TipDialog setSingle(boolean single) {
        isSingle = single;
        return this ;
    }

    public TipDialog setImageResId(int imageResId) {
